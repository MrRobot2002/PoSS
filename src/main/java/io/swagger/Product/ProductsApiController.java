...
public class ProductsApiController implements ProductsApi {
    ...
    public ResponseEntity<List<Product>> listAllProducts(@Parameter(in = ParameterIn.QUERY, description = "First element to show (pagination)" ,schema=@Schema()) @Valid @RequestParam(value = "from", required = false) Long from
